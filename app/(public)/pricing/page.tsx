...
const faqs = [
  {
    question:
      "What is the difference between the Personal and Professional plans?",
    answer:
      "The Professional plan includes all the features of the Personal plan plus unlimited projects and unlimited members per team.",
  },
  {
    question:
      "What is the difference between the Professional and Enterprise plans?",
    answer:
      "The Enterprise plan includes all the features of the Professional plan plus unlimited teams and unlimited members per team.",
  },
  {
    question:
      "What is the difference between the Personal and Enterprise plans?",
    answer:
      "The Enterprise plan includes all the features of the Personal plan plus unlimited teams and unlimited members per team.",
  },
  {
    question:
      "What is the difference between the Professional and Enterprise plans?",
  ...
  },
  {
    ...
    answer:
      "It depends on the plan you choose. For example, the Personal plan costs $200 per month, while the Professional plan costs $500 per month.",
  },
];
    ...
    <div className="flex flex-col gap-20 text-left">
      <div className="flex flex-row justify-between items-center gap-10 flex-wrap">
        ...
        <span className="flex flex-row items-center gap-3 text-fg/90">
          ...
          <Text as="p" size="body" className="text-nowrap">
            Annually <small className="opacity-60">20% off!</small>
          </Text>
        </span>
      </div>
