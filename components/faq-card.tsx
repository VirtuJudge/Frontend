...
export function FaqCard({ question, answer }: FaqCardProps) {
	...
	return <div className="flex flex-col gap-2 max-w-3xl">
		<Wrapper 
			as="div" 
		...
		>
			<Wrapper variant="glass-dark" as="div" className="w-full p-10 flex flex-row items-center justify-between gap-5">
